...
ia.splice(0, 2);
console.log(ia.length);
let phyArray = [3.1415, 2.71828, 2.97 * 10 ^ (-19)];
...
//Verzweigungen
let inputUser = prompt("Bitte gebe zwei Zahlen getrennt von einem : ein. Zum Beispiel", "13:5");
...
let direction = prompt("Gib eine Himmelsrichtung ein. Beispiel:", "Norden");
switch (direction) {
    case "Norden":
...
//Schleifen
let whileInit = 1; //Initaliesierung
while (whileInit <= 10) { //Bedingung
    console.log(whileInit);
    whileInit += 1; //Inkrement
}
let someStrings = ["Hier", "sehen", "wir", "einen", "Array", "von", "Strings"];
/* let someStrings: string[]; */
for (let i = 0; i < someStrings.length; i++) { //für einfaches Ausgeben von allen Einträgen in someStrings[] ist die Benutzung von someStrings.length von Vorteil
